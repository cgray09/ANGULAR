...
export class FormDialogComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    // when edit button is pressed in client-listing.component.html it calls
    // "openDialog" and passes the client id. The data w/ the clientId is 
    // set and passed to this modal
